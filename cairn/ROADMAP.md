...
_Last hygiene check: 2026-09-03 (M10–M13 planned; keepalive candidate added)_

## Milestones

| ID | Title | Status | Depends on | Priority | File/Archive |
|---|---|---|---|---|---|
| M10 | Launcher offline fallback | planned | — | normal | milestones/M10-launcher-offline-fallback.md |
