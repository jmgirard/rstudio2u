Launcher, build-safety, and Docker Hub improvements. No change to the runtime interface (port, user, volume, env vars); moving tags keep working.
...
**Full changelog:** https://github.com/jmgirard/rstudio2u/compare/v1.3...v1.4
