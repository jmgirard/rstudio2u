...
- [ ] AC3: The release bodies of v2.0.0, v2.1.0, v2.2.0 are the former v1.2, v1.3, v1.4 bodies unchanged except that the `**Full changelog:**` compare link in v2.1.0 and v2.2.0 is retargeted to `compare/v2.0.0...v2.1.0` and `compare/v2.1.0...v2.2.0`: `gh release view <new> --json body -q .body` is byte-identical to the T1 capture after that one line's substitution (`sed` over the capture).
